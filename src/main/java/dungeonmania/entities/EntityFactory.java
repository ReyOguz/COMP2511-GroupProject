...
import dungeonmania.Logical.LogicalFactory;
import dungeonmania.entities.Conductors.LightBulb;
import dungeonmania.entities.Conductors.SwitchDoor;
...
public class EntityFactory {
    ...
    public Sceptre buildSceptre() {
        int sceptreMindControlDuration = config.optInt("mind_control_duration");
        return new Sceptre(sceptreMindControlDuration);
    }
    ...
    private Entity constructEntity(JSONObject jsonEntity, JSONObject config) {
        ...
        case "bomb":
            ...
            String bombLogic = config.optString("logic");
            if (bombLogic == "") {
        ...
        case "light_bulb_off":
            return new LightBulb(pos, LogicalFactory.createLogicalRule(jsonEntity.getString("logic")));
        case "switch_door":
            return new SwitchDoor(pos, LogicalFactory.createLogicalRule(jsonEntity.getString("logic")));
        case "wire":
            return new Wire(pos);
        default:
            return null;
