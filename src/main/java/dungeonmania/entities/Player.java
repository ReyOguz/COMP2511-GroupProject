...
public class Player extends Entity implements Battleable {
    ...
    public boolean hasKey(int number) {
        return inventory.hasKey(number) || inventory.hasSunStone();
    }

    public void removeKey(int number) {
        inventory.removeKey(number);
    }
    ...
    public int incrementEnemiesDestroyed() {
    ...
    public boolean pickUp(Entity item) {
        if (((Collectable) item).isTreasure())
    ...
    public int getSceptreDuration() {
        return inventory.getControlDuration();
    }
