...
public class Game {
    ...
    public Game build(String buildable) throws InvalidActionException {
        ...
        if (countEntityOfType(ZombieToast.class) > 0) {
    ...
    public int getEnemiesDestroyed() {
        return player.getEnemiesDestroyed();
    }

    public <T extends Entity> int countEntityOfType(Class<T> type) {
        return map.getEntities(type).size();
    }
